                ...
                <table class="min-w-full divide-y divide-gray-100">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-4 py-3 text-right"><a href="{{ route('bot-tracking.clients.show', $client->id) }}" class="text-xs text-green-600 hover:text-green-800 font-medium">Voir &rarr;</a></td>
                        </tr>
                        @empty
