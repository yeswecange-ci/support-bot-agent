            ...
            <form method="GET" action="{{ route('bot-tracking.search') }}" class="flex flex-wrap items-end gap-4">
                <div class="flex flex-col gap-1 flex-1 min-w-64">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Rechercher dans les messages..." autofocus
                           class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-orange-500 focus:border-green-500 bg-white">
                </div>
                ...
                <button type="submit" class="inline-flex items-center gap-2 px-4 py-2.5 bg-orange-600 text-white text-sm font-medium rounded-lg hover:bg-orange-700 transition shadow-sm">
                ...
                <div class="flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-gray-100">
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        @if($input->conversation->is_client === true || $input->conversation->is_client == 1)
                            <span class="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-orange-100 text-orange-700">Client</span>
